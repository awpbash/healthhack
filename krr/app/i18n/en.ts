...
const en = {
  ...
  dietLoggerScreen: {
    vegeLabel: "Servings of Vegetables",
    vegePlaceholder: "e.g. 1",
    fruitsAndVegesLabel: "Servings of Fruits and Vegetables",
    fruitsAndVegesPlaceholder: "e.g. 1",
    proteinLabel: "Grams of Protein",
    ...
    sugarLabel: "Grams of Sugar",
    sugarPlaceholder: "e.g. 4",
    logLabel: "Log",
    logPlaceholder: "Write any additional notes here",
  },
  loginScreen: {
